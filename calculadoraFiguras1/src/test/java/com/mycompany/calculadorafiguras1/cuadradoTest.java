...
public class cuadradoTest {
    ...
    /**
     * Prueba unitaria para verificar que el método lanza una excepción cuando el lado es negativo.
     */
    @Test(expected = IllegalArgumentException.class)
    public void calcularArea_LadoNegativo_LanzaExcepcion() {
        cuadrado.calcularArea(-3); // Se espera que lance una excepción porque el lado es negativo
    }
